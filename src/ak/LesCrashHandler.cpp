...
#endif // if defined(Q_OS_WIN32)
{
  ...
  if (CreateProcess(NULL, crashReporterPath, NULL, NULL, FALSE, 0, NULL, NULL,
                    &si, &pi))
  {
...
{
  QDir crashReporterFullPathDir(crashReporterFullPath);

  if (!crashReporterFullPathDir.exists())
  {
    crashReporterFullPathDir.mkpath(crashReporterFullPath);
  }
...
/* CrashHandler                                                         */
/************************************************************************/
LesCrashHandler * LesCrashHandler::instance()
{
  static LesCrashHandler globalHandler;

  return &globalHandler;
}

LesCrashHandler::LesCrashHandler()
{
...
void LesCrashHandler::setReportCrashesToSystem(bool report)
{
  d->bReportCrashesToSystem = report;
}

bool LesCrashHandler::writeMinidump()
{
...
void LesCrashHandler::Init(const QString& reportPath,
                           const QString& appPath,
                           const QString& crashReporterFullPath)
{
